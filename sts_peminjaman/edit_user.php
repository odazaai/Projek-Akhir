...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <h1 class="mt-4"><center>Edit Data Barang</center></h1>
                <br>
                <div class="container">
                <div class="card mx-auto col-lg-6 ">
                    ...
                    <div class="mb-3">
                        <label form="disabledTextInput" class="form-label">No Identitas</label>
                        <input type="text" id="no_identitas" name="no_identitas" class="form-control" value="<?php echo $user['no_identitas'];?>">
                    </div>
                    <div class="mb-3">
                        <label form="disabledTextInput" class="form-label">Nama</label>
                        <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $user['nama'];?>">
                    </div>
                    <div class="mb-3">
                        <label form="disabledTextInput" class="form-label">Status</label>
                        <input type="text" id="status" name="status" class="form-control" value="<?php echo $user['status'];?>">
                    </div>
                    <div class="mb-3">
                        <label form="disabledTextInput" class="form-label">username</label>
                        <input type="text" id="username" name="username" class="form-control" value="<?php echo $user['username'];?>">
                    </div>
                    <div class="mb-3">
                        <label form="disabledTextInput" class="form-label">password</label>
                        <input type="password" id="password" name="password" class="form-control" value="<?php echo $user['password'];?>">
                    </div>
                    <div class="mb-3">
                        <label form="disabledTextInput" class="form-label">role</label>
