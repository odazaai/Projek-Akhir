                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="form_user.php" class="btn btn-success" style="float: right;">Tambah User</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="datatablesSimple" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='edit_user.php?id=<?= $data['id'] ?>' class="btn btn-success btn-small">Edit</a>
                                                    <?php echo "<a href='javascript:hapusData(".$data['id'].")'' class='btn btn-danger btn-small'>Hapus</a>"; ?>
                                                </td>
                                            </tr>
                                            <?php 
                                            $no++;
