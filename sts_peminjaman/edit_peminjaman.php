...
$data=Editpeminjaman("peminjaman",$_GET['id_peminjaman']);
// var_dump($data);
?>
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="card mx-auto col-lg-6 ">
                    ...
                    <form action="update_peminjaman.php" method="POST">
                        <input type="hidden" id="id_peminjaman" name="id_peminjaman" value="<?php echo $peminjaman['id_peminjaman'];?>">
                        <div class="mb-3">
                            <label form="status" class="form-label">Status</label>
                            <select id="disabledSelect" class="form-control" name="status" value="<?php echo $peminjaman['status']; ?>">
                                <option >Sudah Kembali</option>
                                <option >Belum Kembali</option>
                            </select>
                        </div>
                    <button type="submit" class="btn btn-success" name="submit" value="Update">Save Changes</button>
                    <br>
                </form>
                <?php endwhile;?>
                    </div>
